#!/usr/bin/env python
"""
Run ST-GNN experiments (GNN + temporal encoder).

Usage:
    python scripts/run_stgnn.py --temporal lstm
    python scripts/run_stgnn.py --temporal gru
    python scripts/run_stgnn.py --temporal mha
...
def run_single_stgnn(temporal_type: str, train_loader, val_loader, test_loader,
                      adj_tensor, scaler, use_wandb: bool = False):
    """Run one ST-GNN experiment."""
...
def main():
    parser = argparse.ArgumentParser(description="Run ST-GNN experiments")
    parser.add_argument(
    ...
    print("\n✓ All ST-GNN experiments complete.")
